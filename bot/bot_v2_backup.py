...
BOT_API_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiYm90Iiwicm9sZSI6InRlYWNoZXIiLCJmdWxsX25hbWUiOiJEaWdpdGFsVHV0b3IgQm90IiwidHlwZSI6InNlcnZpY2UiLCJjcmVhdGVkX2F0IjoiMjAyNi0wMy0yOFQxMTo0OTozMC44NTEzNzYifQ.y2fzBuQ9fYLd2W19aE2J_FPFwKrdxHYJ5K--OZrecjg"
...
async def admin_ai_analyze(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    context.user_data['admin_state'] = 'awaiting_work_id_for_ai'
...
def main():
    ...
    # Admin message handlers (должны быть после всех Regex)
